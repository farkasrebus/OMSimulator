...
void ThermostatMonitor_HeatingOnMonitor_function_initSample(DATA *data, threadData_t *threadData)
{
  long i=0;
}

const char *ThermostatMonitor_HeatingOnMonitor_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
...
int ThermostatMonitor_HeatingOnMonitor_function_ZeroCrossingsEquations(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int ThermostatMonitor_HeatingOnMonitor_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  TRACE_PUSH
...
const char *ThermostatMonitor_HeatingOnMonitor_relationDescription(int i)
{
...
int ThermostatMonitor_HeatingOnMonitor_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  TRACE_PUSH
...
int ThermostatMonitor_HeatingOnMonitor_checkForDiscreteChanges(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  int needToIterate = 0;
