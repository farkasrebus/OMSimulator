...
#define MODEL_IDENTIFIER ThermostatMonitor_ThermostatOnMonitor
#define MODEL_GUID "{55315148-79cb-4f7c-86db-0269bfc53883}"
...
extern void ThermostatMonitor_ThermostatOnMonitor_setupDataStruc(DATA *data);
#define fmu2_model_interface_setupDataStruc ThermostatMonitor_ThermostatOnMonitor_setupDataStruc
