  ...
  extern "C" {
#endif
  int ThermostatMonitor_CriticalTemperatureMonitor_mayer(DATA* data, modelica_real** res, short*);
  int ThermostatMonitor_CriticalTemperatureMonitor_lagrange(DATA* data, modelica_real** res, short *, short *);
